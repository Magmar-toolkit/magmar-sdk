...
export interface SendUserOpResponse {
	userOpHash: Hash,
...
export interface ClientOptions {
	...
	privateKey?: string;
	rpcUrl?: string;
	isSponsoredTrx?: boolean
	noAccountCreateSponsorship?: boolean
	paymasterEndpoint?: string;
	paymaster?: "PIMLICO" | "STACKUP" | "MAGMAR";
	paymasterId?: string; //for magmar paymaster
	erc20token?: string;
